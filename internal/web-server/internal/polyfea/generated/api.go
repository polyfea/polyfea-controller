...
// Valid indicates whether the value is a known member of the MicrofrontendResourceKind enum.
func (e MicrofrontendResourceKind) Valid() bool {
	switch e {
	case Link:
		return true
	case Script:
...
func HandlerWithOptions(si ServerInterface, options StdHTTPServerOptions) http.Handler {
	...
	m.HandleFunc(http.MethodGet+" "+options.BaseURL+"/context-area/{name}", wrapper.GetContextArea)
	m.HandleFunc(http.MethodGet+" "+options.BaseURL+"/static-config", wrapper.GetStaticConfig)

...
# - use the DEFAULT_CHANNEL as arg of the bundle target (e.g make bundle DEFAULT_CHANNELF=stable)
...
.PHONY: test
test: manifests generate  openapi boot-package register-package sw-package fmt vet setup-envtest ## Run tests.
...
KIND_CLUSTER ?= polyfea-controller-test-e2e
